...
const ResultPage: React.FC<ResultPageProps> = ({ file, text, result }) => {
          ...
          <div className="sample-result" style={{ display: 'none' }}>
            <div className="result-item danger">
              ...
              <p className="result-explanation">
                <strong>이유:</strong> 일반적으로 손해배상의 범위를 제한하는 것이 공정합니다. 무제한 손해배상은 을의 부담을 과도하게 증가시킬 수 있습니다.
              </p>
              <div className="result-suggestion">
                <strong>💡 제안:</strong> "을의 손해배상 책임은 을이 받은 수수료의 12개월분을 초과하지 않는다" 등으로 명확한 한계를 설정할 것을 권장합니다.
              </div>
            </div>
          </div>
        </div>
